...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _importExcelFile() async {
    ...
    if (importedData != null) {
      log('File imported successfully: ${importedData!.keys.firstOrNull}');
    } else {
  ...
  Future<Map<String, Excel>?> importData() async {
    ...
    for (final file in filePickerResult.files) {
      ...
      try {
        ...
        excelRepository = ExcelFileRepository();
